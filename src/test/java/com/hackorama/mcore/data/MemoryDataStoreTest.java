...
public class MemoryDataStoreTest {
    ...
    public void datastore_insertedMultiKeyValues_matchesOnGettingByKey() {
        dataStore.putDuplicate("TABLE_ONE", "1_1", "one_one");
        dataStore.putDuplicate("TABLE_ONE", "1_2", "one_two");
        dataStore.putDuplicate("TABLE_ONE", "1_3", "one_three");
        dataStore.putDuplicate("TABLE_ONE", "1_4", "one_same");
        dataStore.putDuplicate("TABLE_ONE", "1_5", "one_same");
        dataStore.putDuplicate("TABLE_ONE", "1_6", "one_same");
        dataStore.putDuplicate("TABLE_ONE", "1_7", "one_seven");

        dataStore.putDuplicate("TABLE_TWO", "1_1", "two_one");
        dataStore.putDuplicate("TABLE_TWO", "1_2", "two_two");
        dataStore.putDuplicate("TABLE_TWO", "1_3", "two_three");
        dataStore.putDuplicate("TABLE_TWO", "1_0", "two_four");
        dataStore.putDuplicate("TABLE_TWO", "1_0", "two_five");
        dataStore.putDuplicate("TABLE_TWO", "1_0", "two_six");
        dataStore.putDuplicate("TABLE_TWO", "1_7", "two_seven");


        assertTrue(dataStore.contains("TABLE_ONE", "1_1"));
        assertFalse(dataStore.contains("TABLE_ONE", "false"));

        assertEquals("one_one", dataStore.getDuplicate("TABLE_ONE", "1_1").get(0));
        assertEquals("one_two", dataStore.getDuplicate("TABLE_ONE", "1_2").get(0));
        assertEquals("one_three", dataStore.getDuplicate("TABLE_ONE", "1_3").get(0));

        assertEquals("two_one", dataStore.getDuplicate("TABLE_TWO", "1_1").get(0));
        assertEquals("two_two", dataStore.getDuplicate("TABLE_TWO", "1_2").get(0));
        assertEquals("two_three", dataStore.getDuplicate("TABLE_TWO", "1_3").get(0));

        dataStore.remove("TABLE_ONE", "1_2");
        assertEquals("one_one", dataStore.getDuplicate("TABLE_ONE", "1_1").get(0));
        assertEquals(0, dataStore.getDuplicate("TABLE_ONE", "1_2").size());
        assertEquals("one_three", dataStore.getDuplicate("TABLE_ONE", "1_3").get(0));
        assertFalse(dataStore.contains("TABLE_ONE", "1_2"));
        ...
        assertEquals(3, dataStore.getDuplicate("TABLE_TWO", "1_0").size());
        assertTrue(dataStore.getDuplicate("TABLE_TWO", "1_0").contains("two_four"));
        assertTrue(dataStore.getDuplicate("TABLE_TWO", "1_0").contains("two_five"));
        assertTrue(dataStore.getDuplicate("TABLE_TWO", "1_0").contains("two_six"));
    }
